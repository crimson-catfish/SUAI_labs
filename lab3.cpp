...
int main()
{
    ...
    do
    {
        ...
        {
            case M1:
                S = M_PI/4 + M_PI/12 - (M_PI/6 - sqrt(3)/4);
                printf("Point belongs to area M1. S1 = %f", S);
                break;
            case M2:
                S = M_PI/12 - (M_PI/6 - sqrt(3)/4);
            ...
            case M3:
                ...
                break;
            case M4:
                S = 1 - M_PI/4 - (1 - (M_PI/4 + M_PI/12 - (M_PI/6 - sqrt(3)/4)))*2;
                printf("Point belongs to area M4. S4 = %f", S);
                break;
            case M5:
                S = (1 - (M_PI/4 + M_PI/12 - (M_PI/6 - sqrt(3)/4))) + M_PI/12 - (M_PI/6 - sqrt(3)/4) + M_PI/2;
